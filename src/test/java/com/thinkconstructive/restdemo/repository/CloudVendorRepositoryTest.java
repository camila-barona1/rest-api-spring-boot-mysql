...
public class CloudVendorRepositoryTest {
  ...
  //  given - when - then
    ...
    @BeforeEach
    void setUp() {
        cloudVendor = new Vendor("1","Amazon",
                "USA", "xxxxx");
    ...
    {
        List<Vendor> cloudVendorList = cloudVendorRepository.findByVendorName("Amazon");
    ...
    {
        List<Vendor> cloudVendorList = cloudVendorRepository.findByVendorName("GCP");
